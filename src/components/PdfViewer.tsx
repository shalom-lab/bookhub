...
import { PDFViewer, PDFViewerRef, ScrollStrategy } from '@embedpdf/react-pdf-viewer';
...
const THEME_CONFIGS = {
  light: { preference: 'light' as const },
  dark: { preference: 'dark' as const },
  sepia: {
    preference: 'light' as const,
    light: {
      background: { app: "#FBF0D9", surface: "#FBF0D9", surfaceAlt: "#F2E2C4", input: "#F2E2C4" },
      foreground: { primary: "#5F4B32", secondary: "#7A654D" },
      accent: { primary: "#8B7E66", primaryHover: "#7A654D" },
      border: { default: "rgba(95, 75, 50, 0.1)" }
    }
  },
  green: {
    preference: 'light' as const,
    light: {
      background: { app: "#E1EAD8", surface: "#E1EAD8", surfaceAlt: "#D5E0CB", input: "#D5E0CB" },
      foreground: { primary: "#2C3E50", secondary: "#3E5871" },
      accent: { primary: "#4A6B8A", primaryHover: "#3E5871" },
      border: { default: "rgba(44, 62, 80, 0.1)" }
    }
  }
};
